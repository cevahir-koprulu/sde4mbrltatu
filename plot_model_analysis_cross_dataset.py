...
def compute_results(task, model_task, results_path, models_to_evaluate, data_horizon=50, num_steps=1, num_particles=10, num_splits=1, eval_traj_type=1):
    dataset = load_dataset(task, verbose=False)
    env_infos = get_environment_infos_from_name(task)
    models_dict = get_models_dict(model_task, models_to_evaluate, env_infos["stepsize"], 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-task", type=str, default="halfcheetah-random-v2")
    parser.add_argument("--results-dir", type=str, default="model_analysis_cross_dataset_results")
    ...
    models_to_evaluate = {
        ...
        "hopper-medium-expert-v2": [
            ...
            {
                "model_name" : "critic_num_2_seed_32_0518_155743-hopper_medium_expert_v2_tatu_mopo",
                "plot_name" : "Ens",
                "is_gaussian" : True,
            }
        ],
        "hopper-medium-replay-v2": [
            ...
            {
                "model_name" : "critic_num_2_seed_32_0518_155812-hopper_medium_replay_v2_tatu_mopo",
                "plot_name" : "Ens",
                "is_gaussian" : True,
            }
        ],
        "hopper-medium-v2": [
            ...
            {
                "model_name" : "critic_num_2_seed_32_0518_155841-hopper_medium_v2_tatu_mopo",
                "plot_name" : "Ens",
                "is_gaussian" : True,
            }
        ],
        "hopper-random-v2": [
            ...
            {
                "model_name" : "critic_num_2_seed_32_0518_155909-hopper_random_v2_tatu_mopo",
                "plot_name" : "Ens",
                "is_gaussian" : True,
            }
        ],
    ...
    results_path = f"{args.results_dir}/results_{args.model_task}_IN_{args.task}_type={args.eval_traj_type}.pkl"
    ...
    if os.path.exists(results_path) and args.load_results:
        ...
        results_dict = compute_results(
            task=args.task, model_task=args.model_task, results_path=results_path,
            models_to_evaluate=models_to_evaluate[args.model_task],
    ...
    if args.plot_results:
        fig_path = f"{args.results_dir}/fig_{args.model_task}_IN_{args.task}_type={args.eval_traj_type}"
